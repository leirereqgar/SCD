...
class HoareMonitor
{
   ...
   Semaphore * mutex_sem = nullptr;

   // queue for threads waiting to re-enter the monitor after signal
   Semaphore * urgent_sem   = nullptr ; // semaphore for urgent processes
   unsigned    urgent_count = 0 ;       // number of threads waiting in urgent semaphore
